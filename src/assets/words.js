...
const phiTauWords = [
  ...
  'Rib', 'Vannah', 'Case Race', 'Movie Night', 'Wine', 'Rossi Jug', 'The Lizard', 'Kreepy Kyle', 'Garret', 'Thumper', 'Hogger', 'True American Hero', 'Campo', 'Fire', 'Volcano', 'Red Room', 'Serious Fun', 'Hot Tub Club', 'Drink if it is anal', 'Everclear', 'Gin', 'Genny', "St. Patty's Day", 'Rush Week', 'Piss bucket',
